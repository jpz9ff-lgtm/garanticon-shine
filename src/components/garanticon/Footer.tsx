        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 font-semibold">hola@garanticon.es</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-primary/20 text-primary">
            ...
            <div>
              <p className="text-sm font-semibold text-background/60">Dirección</p>
              <p className="mt-1 font-semibold">Calle Gran Vía 1, 28013 Madrid</p>
            </div>
          </div>
        </div>
